 ...
 * BrandIcons.tsx
 *
 * The GitHub and LinkedIn marks, written out as plain SVG.
 *
 * Why these aren't imported from lucide-react: Lucide 1.0 removed every
 * brand logo from the library. Rather than install a second icon package
 * for two icons, they live here — no dependency, and nothing that can
 * break on a future update.
 *
 * Both take a `size` prop and inherit the surrounding text colour, so
 * they behave exactly like the lucide icons used elsewhere.
 */
